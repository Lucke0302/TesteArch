...
public class ArchJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(AllosaurusEggServerProvider.INSTANCE, DimorphodonEggBlock.class);
        ...
        registration.registerEntityDataProvider(AllosaurusServerProvider.INSTANCE, DimorphodonEntity.class);
    }
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(AllosaurusEggClientProvider.INSTANCE, DimorphodonEggBlock.class);
        ...
        registration.registerEntityComponent(AllosaurusClientProvider.INSTANCE, DimorphodonEntity.class);
    }
}