...
import com.lucas.arch.client.model.PachycephalosaurusModel;
...
public class PachycephalosaurusRenderer<R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<PachycephalosaurusEntity, R> {
    ...
    @Override
    public void extractRenderState(PachycephalosaurusEntity entity, R state, float partialTick) {
