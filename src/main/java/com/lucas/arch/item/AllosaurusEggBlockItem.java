...
public class AllosaurusEggBlockItem extends ArchBlockItem {

    public AllosaurusEggBlockItem(Block block, Properties properties, String designer, String programmer) {
    ...
    protected boolean placeBlock(BlockPlaceContext context, BlockState state) {
        ...
        if (placed && !context.getLevel().isClientSide()) {
            ...
            if (be instanceof AllosaurusEggBlockEntity eggBE) {
